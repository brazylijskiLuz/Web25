export const PENSION_CALCULATOR_PROMPT = (
  beforeInput: string,
  afterInput: string,
  beforeOutput: string
) => {
  return `
dobra taka jest umowa. 


tutaj jest obiekt ktory wygneerowal bot dla tego samego kontekstu ponizej
...
teraz to jest tam user, tylko zmienily jakies propeties i wyglada ten obiekt w taki sposob teraz:

${afterInput}

tutaj jest ten kontekst. zrob to jeszcze raz po prostu tylko z tymi nowymi danymi

# Jesteś ekspertem od polskiego systemu emerytalnego ZUS. Oblicz prognozowaną emeryturę według zasad obowiązujących w Polsce (nowy system emerytalny dla osób urodzonych po 31.12.1948 r.).
